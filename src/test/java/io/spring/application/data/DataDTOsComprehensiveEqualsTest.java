...
public class DataDTOsComprehensiveEqualsTest {
  ...
  void should_test_articledata_equals_with_mixed_null_fields() {
    ...
    ArticleData article1 =
        new ArticleData(
            "id", null, "title", null, "body", false, 0, now, null, Arrays.asList("tag"), null);
    ArticleData article2 =
        new ArticleData(
            "id", null, "title", null, "body", false, 0, now, null, Arrays.asList("tag"), null);
    ArticleData article3 =
        new ArticleData(
            "id", "slug", "title", null, "body", false, 0, now, null, Arrays.asList("tag"), null);
  ...
  void should_test_all_dtos_equals_with_different_object_types() {
    ArticleData article =
        new ArticleData(
            ...
            null);
    CommentData comment =
        new CommentData("id", "body", "article1", DateTime.now(), DateTime.now(), null);
