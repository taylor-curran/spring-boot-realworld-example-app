...
public class UserWithTokenTest {
  ...
  public void should_create_user_with_token_from_user_data() {
    UserData userData =
        new UserData(
            "user123", "test@example.com", "testuser", "Test bio content", "profile-image.jpg");
  ...
  public void should_handle_null_user_data_fields() {
    UserData userData = new UserData("user123", null, null, null, null);
  ...
  public void should_handle_empty_user_data_fields() {
    UserData userData = new UserData("user123", "", "", "", "");
    String token = "";
  ...
  public void should_handle_long_content() {
    ...
    UserData userData = new UserData("user123", longEmail, longUsername, longBio, longImage);
  ...
  public void should_handle_whitespace_content() {
    UserData userData =
        new UserData(
            "user123", "  email@example.com  ", "  username  ", "  bio content  ", "  image.jpg  ");
  ...
  public void should_handle_multiline_bio() {
    ...
    UserData userData =
        new UserData("user123", "test@example.com", "testuser", multilineBio, "image.jpg");
    String token = "jwt-token-123";
  ...
  public void should_handle_null_token() {
    UserData userData =
        new UserData("user123", "test@example.com", "testuser", "Test bio", "image.jpg");
  ...
  public void should_preserve_user_data_integrity() {
    UserData originalUserData =
        new UserData(
            "user123", "original@example.com", "originaluser", "Original bio", "original.jpg");
