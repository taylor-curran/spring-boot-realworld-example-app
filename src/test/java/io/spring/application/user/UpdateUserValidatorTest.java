...
public class UpdateUserValidatorTest {
  ...
  public void should_be_invalid_when_email_belongs_to_different_user() {
    User differentUser =
        new User("different@example.com", "differentuser", "password", "bio", "image.jpg");
    when(userRepository.findByEmail("new@example.com")).thenReturn(Optional.of(differentUser));
    when(userRepository.findByUsername("newuser")).thenReturn(Optional.empty());

    when(context.buildConstraintViolationWithTemplate("email already exist"))
  ...
  public void should_be_invalid_when_username_belongs_to_different_user() {
    ...
    when(context.buildConstraintViolationWithTemplate("username already exist"))
        .thenReturn(violationBuilder);
  ...
  public void should_be_invalid_when_both_email_and_username_belong_to_different_users() {
    User differentUser1 =
        new User("different1@example.com", "differentuser1", "password", "bio", "image.jpg");
    User differentUser2 =
        new User("different2@example.com", "differentuser2", "password", "bio", "image.jpg");
  ...
  public void should_handle_null_email_input() {
    UpdateUserParam nullEmailParam =
        new UpdateUserParam(null, "password", "newuser", "bio", "image");
  ...
  public void should_handle_null_username_input() {
    UpdateUserParam nullUsernameParam =
        new UpdateUserParam("new@example.com", "password", null, "bio", "image");
  ...
  public void should_handle_empty_email_input() {
    UpdateUserParam emptyEmailParam =
        new UpdateUserParam("", "password", "newuser", "bio", "image");
  ...
  public void should_handle_empty_username_input() {
    UpdateUserParam emptyUsernameParam =
        new UpdateUserParam("new@example.com", "password", "", "bio", "image");
